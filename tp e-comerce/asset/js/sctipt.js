...
function displayTopBotCart() {
    ...
    buttonClear.textContent = 'Nettoyer les preuves';
    ...
    buttonPay.textContent = 'Tu payes batard';
...
const products = [
    {
        name: 'Anti belle-mère',
        category: 'couteaux',
        price: '50',
    },
    {
        name: 'Pour random dans la rue',
        category: 'couteaux',
        price: '50',
    },
    {
        name: 'Pour transports en commun',
        category: 'couteaux',
        price: '50',
    },
    {
